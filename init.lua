...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      --
      -- DAVID'S NOTE TO SELF:
      -- When you type :Telescope and enter into Telescope, you are automatically
      -- in Insert mode. In this mode <c-/> shows keymaps that can be used in this mode.
      -- When you Esc from Insert mode you are in Normal mode. Similarly, ? shows keymaps in Normal mode. Esc again exits.
      --
  ...
  -- David: Claude Code extension with diff view!
  -- NOTE: I added this just to have better Claude Code integration, this is not essential to my nvim setup
  {
